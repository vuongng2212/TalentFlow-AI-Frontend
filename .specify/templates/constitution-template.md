...
## Governance
- This Constitution is the authoritative standard for all development in [PROJECT_NAME]. Any deviation or code pattern that conflicts with these principles MUST be rejected during code reviews unless explicit business justification is documented in the feature's implementation plan under complexity tracking.
